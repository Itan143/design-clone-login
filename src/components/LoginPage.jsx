...
import aribaIllustration from "@/assets/ariba-illustration.png";
        ...
        <div className="flex items-center justify-center">
          <Card className="w-full max-w-md p-8 shadow-xl">
            ...
            <form className="space-y-4">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-12 pl-10 pr-10 border-gray-300"
                />
                <div className="absolute left-3 top-1/2 transform -translate-y-1/2">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Button
                type="submit"
                className="w-full h-12 bg-ariba-green hover:bg-ariba-green/90 text-white font-medium"
                onClick={(e) => {
                  e.preventDefault();
            ...
            <div className="mt-6 text-center">
              ...
              <Button
                variant="outline"
                className="w-full h-12 bg-ariba-orange hover:bg-ariba-orange/90 text-white border-ariba-orange font-medium"
